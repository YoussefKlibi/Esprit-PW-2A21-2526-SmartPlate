...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-logo">
            <img src="C:\Youssef\2A\ProjetWeb\SmartPlate\Logo\logo.png" alt="Logo" height="80%" width="50%">
            <h2>SmartPlate</h2>
        </div>
        ...
        <header class="dashboard-header" style="flex-direction: column; align-items: stretch; gap: 1.5rem; margin-bottom: 2rem;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
                ...
                <div style="display: flex; gap: 1.5rem; align-items: center;">
                    <form action="index.php" method="GET" style="display: flex; gap: 0.5rem; align-items: center; border-right: 2px solid #e2e8f0; padding-right: 1.5rem;">
                    ...
                    <form action="index.php?action=addJournal" method="POST" style="display: flex; gap: 0.5rem; align-items: center;">
                        <input type="date" name="date_journal" class="form-control" style="padding: 0.4rem; width: auto; font-size: 0.9rem;">
                        <input type="number" name="poids_actuel" class="form-control" placeholder="Poids (kg)" step="0.1" style="padding: 0.4rem; width: 100px; font-size: 0.9rem;">
                        <button type="submit" class="btn-main" style="padding: 0.4rem 1rem; font-size: 0.9rem;">+ Créer</button>
                    </form>
                </div>
            </div>
            ...
            <div class="active-journal-bar" style="display: flex; justify-content: space-between; align-items: center; background: white; padding: 1rem 1.5rem; border-radius: 16px; box-shadow: var(--shadow); border-left: 4px solid var(--green-light);">
                <div class="journal-info-left" style="display: flex; align-items: center; gap: 1rem;">
                    <span class="date-badge" style="font-size: 1.1rem; font-weight: 600;">📅 2 Avril 2026</span>
                    <span class="badge white" style="border: 1px solid #e2e8f0; font-weight: 600;">⚖️ 75.5 kg</span>
                    <span class="badge green-light">Journal Actif</span>
                </div>
                
                <div class="journal-actions-right" style="display: flex; gap: 0.8rem;">
                    <button class="btn-icon" style="display: flex; align-items: center; gap: 5px; background: none; border: 1px solid #e2e8f0; padding: 5px 10px; border-radius: 8px; cursor: pointer;">
                        ✏️ Modifier
                    </button>
                    <a href="index.php?action=deleteJournal&id=1" class="btn-icon danger" style="text-decoration: none; color: #e53e3e; border: 1px solid #feb2b2; padding: 5px 10px; border-radius: 8px;" onclick="return confirm('Voulez-vous vraiment supprimer ce journal et ses repas ?');">
                        🗑️ Supprimer
                    </a>
                </div>
            </div>
    ...
    <form action="index.php?action=addRepas" method="POST" class="modern-form">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" id="qte" name="qte" class="form-control" placeholder="Ex: 150">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" id="nbre_calories" name="nbre_calories" class="form-control" placeholder="Ex: 250">
            </div>
            <div class="form-group">
                <label for="proteine">Protéines (g)</label>
                <input type="number" id="proteine" name="proteine" class="form-control" placeholder="Ex: 30">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" id="glucide" name="glucide" class="form-control" placeholder="Ex: 0">
            </div>
            <div class="form-group">
                <label for="lipide">Lipides (g)</label>
                <input type="number" id="lipide" name="lipide" class="form-control" placeholder="Ex: 5">
            </div>
        </div>
