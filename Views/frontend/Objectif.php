...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-footer">
            <div class="user-badge">
                <img src="https://ui-avatars.com/api/?name=<?= urlencode($userInfo['prenom'] . ' ' . $userInfo['nom']) ?>&background=d4f283&color=1a1a1a&rounded=true"
                    alt="Avatar">
                <div class="user-info">
                    <span class="user-name"><?= htmlspecialchars($userInfo['prenom']) ?></span>
    ...
    <div class="dashboard">
        ...
        <header class="dashboard-header">
            <h1>Mes Objectifs</h1>
            <span class="date-badge">Mis Ã  jour le 15 Mars</span>
        </header>
        ...
        <div class="journal-grid">
            ...
            <div class="card health-card">
                <div class="card-header">
                    ...
                    <span class="badge white">Perte de poids</span>
                </div>
                <div class="health-content">
                    <div class="weight-display">
                        <div class="weight-item">
                            <span class="weight-label">Actuel</span>
                            <span class="weight-value">75 kg</span>
                        </div>
                        <div class="weight-divider">âž”</div>
                        <div class="weight-item">
                            <span class="weight-label">Cible</span>
                            <span class="weight-value">70 kg</span>
                        </div>
                    </div>
                    ...
                    <p class="encouragement">Encore 5 kg pour atteindre ton but, <?= htmlspecialchars($userInfo['prenom']) ?> !</p>
                </div>
            </div>

            <div class="card progress-card">
                <div class="card-header">
                    <h2>Cibles JournaliÃ¨res</h2>
                    <span class="badge yellow">2000 kcal/jour</span>
                </div>
                <div class="progress-content">
                    <div class="macros-summary full-width">
                        <div class="macro-item">
                            <div class="macro-title"><span class="dot blue"></span> Glucides (50%)</div>
                            <span class="macro-target">250g</span>
                        </div>
                        <div class="macro-item">
                            <div class="macro-title"><span class="dot yellow"></span> ProtÃ©ines (30%)</div>
                            <span class="macro-target">150g</span>
                        </div>
                        <div class="macro-item">
                            <div class="macro-title"><span class="dot green"></span> Lipides (20%)</div>
                            <span class="macro-target">44g</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                <div class="card">
                    <div class="card-header">
                        <h2>GÃ©rer mon objectif</h2>
                    </div>

                    <form action="index.php?action=updateObjectif" method="POST" class="modern-form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label for="Date_Fin">Date de fin (prÃ©vue)</label>
                                <input type="date" id="Date_Fin" name="Date_Fin" class="form-control" required>
                            </div>
                        </div>

                        <div class="form-actions">
                            <a href="index.php?action=deleteObjectif" class="btn-danger"
                                onclick="return confirm('Es-tu sÃ»r de vouloir supprimer cet objectif ?');">
