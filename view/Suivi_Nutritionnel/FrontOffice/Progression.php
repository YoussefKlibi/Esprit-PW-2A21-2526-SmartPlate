...
<?php
    ...
    $chatbotControllerUrl = '../../../controller/Suivi_Nutritionnel/ChatbotController.php';

    // Récupération de l'objectif actif pour l'utilisateur connecté
...
<script>
    // Expose the controller URL to the static JS file in a safe way
    window.CHATBOT_CONTROLLER_URL = <?php echo json_encode($chatbotControllerUrl, JSON_UNESCAPED_SLASHES); ?>;
    window.SP_CHAT_USER_ID = <?php echo (int)$id_utilisateur_connecte; ?>;
</script>
