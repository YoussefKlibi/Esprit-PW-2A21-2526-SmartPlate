...
<div class="dashboard">
    ...
    <form action="../../../controller/Suivi_Nutritionnel/ObjectifController.php?action=<?php echo $objectifActuel ? 'update&id='.$objectifActuel['id_objectif'] : 'add'; ?>" method="POST">
    ...
    <div id="timeInputGroup" style="display: none; margin-top: 15px; padding-left: 28px; border-left: 2px solid var(--admin-green);">
        ...
        <div class="form-actions" style="margin-top: 20px; display: flex; justify-content: space-between;">
            ...
            <?php if($objectifActuel): ?>
                <a href="../../../controller/Suivi_Nutritionnel/ObjectifController.php?action=delete&id=<?php echo $objectifActuel['id_objectif']; ?>" 
