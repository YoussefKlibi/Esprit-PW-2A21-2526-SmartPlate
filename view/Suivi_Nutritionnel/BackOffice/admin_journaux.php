<?php
require_once __DIR__ . '/../../../controller/Suivi_Nutritionnel/JournalController.php';
...
<body>
        ...
        <div class="sidebar-menu">
            ...
            <div class="nav-dropdown">
                ...
                <div id="suiviNutritionnelMenu" style="display: block; background: rgba(0,0,0,0.03); border-radius: 8px; margin-bottom: 5px; padding-top: 5px; padding-bottom: 5px;">
                    <a href="admin_dashboard.php" class="menu-item" style="padding-left: 40px; font-size: 0.9em; margin-bottom: 2px;">📊 Dashboard Analytics</a>
                    ...
                    <a href="admin_journaux.php" class="menu-item active" style="padding-left: 40px; font-size: 0.9em; margin-bottom: 2px;">🍽️ Journaux Utilisateurs</a>
                </div>
            </div>
    ...
    <main class="main-content">
        ...
        <div id="sectionAjout" style="display: none; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; margin-bottom: 20px; border-left: 4px solid #20c997;">
            ...
            <form id="adminJournalForm" action="../../../controller/Suivi_Nutritionnel/JournalController.php?action=add" method="POST" class="modern-form">
                    ...
                    <?php if (!empty($listeJournaux)): ?>
                        ...
                        <tr style="border-bottom: 1px solid #e2e8f0;">
                            ...
                            <td style="padding: 10px; display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
                                ...
                                <a href="../../../controller/Suivi_Nutritionnel/JournalController.php?action=delete&id=<?php echo urlencode($journal['id_journal']); ?>" style="color: red; text-decoration: none;" onclick="return confirm('Supprimer ce journal et tous les repas associés ?');">🗑️ Suppr.</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
        ...
        <div id="sectionAjoutRepas" class="card admin-soft-card" style="display: none; margin-top: 24px;">
            ...
            <div class="card-body" style="padding-top:12px;">
                <form id="adminRepasForm" action="../../../controller/Suivi_Nutritionnel/RepasController.php?action=add" method="POST" enctype="multipart/form-data" class="modern-form">
                    <div class="form-row">
                    ...
                    <?php if (!empty($listeRepas)): ?>
                        ...
                        <tr style="border-bottom: 1px solid #e2e8f0;" data-id_journal="<?php echo htmlspecialchars($repas['id_journal'] ?? ''); ?>" data-user="<?php echo htmlspecialchars($repas['id_utilisateur'] ?? ''); ?>">
                            ...
                            <td style="padding: 10px;">
                                ...
                                <a href="../../../controller/Suivi_Nutritionnel/RepasController.php?action=delete&id=<?php echo urlencode($repas['id_repas']); ?>" style="color: red; text-decoration: none;" onclick="return confirm('Supprimer ce repas ?');">Suppr.</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
