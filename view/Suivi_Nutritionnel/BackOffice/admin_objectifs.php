<?php
    require_once __DIR__ . '/../../../controller/Suivi_Nutritionnel/ObjectifController.php';
        ...
        <div class="sidebar-menu">
            ...
            <div class="nav-dropdown">
                ...
                <div id="suiviNutritionnelMenu" style="display: block; background: rgba(0,0,0,0.03); border-radius: 8px; margin-bottom: 5px; padding-top: 5px; padding-bottom: 5px;">
                    ...
                    <a href="admin_objectifs.php" class="menu-item active" style="padding-left: 40px; font-size: 0.9em; margin-bottom: 2px;">🎯 Modération Objectifs</a>
...
<form id="objectifForm" action="../../../controller/Suivi_Nutritionnel/ObjectifController.php?action=add" method="POST">
    ...
    <td style="padding: 10px; display: flex; gap: 8px; align-items: center;">
        ...
        <a href="../../../controller/Suivi_Nutritionnel/ObjectifController.php?action=delete&id=<?php echo $obj['id_objectif']; ?>" 
