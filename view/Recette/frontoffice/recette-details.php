        ...
        <div class="card recipe-hero-card">
            <div class="recipe-hero-media">
                <?php if (!empty($recette['image'])) { ?>
                    <img src="../../../images/<?= htmlspecialchars($recette['image']) ?>" alt="<?= htmlspecialchars($recette['nom_recette']) ?>">
                <?php } else { ?>
                    <img src="https://via.placeholder.com/600x300?text=Recette" alt="<?= htmlspecialchars($recette['nom_recette']) ?>">
                <?php } ?>
            </div>
