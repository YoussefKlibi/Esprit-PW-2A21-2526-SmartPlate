...
require_once __DIR__ . "/../../../Models/Recette/PlanificateurMetier.php";
            ...
            <?php foreach ($resultatPlanning['planning'] as $item) { ?>
                <div class="meal-card">
                    <div class="meal-image">
                        <?php if (!empty($item['recette']['image'])) { ?>
                            <img src="../../../images/<?= htmlspecialchars($item['recette']['image']) ?>" alt="recette">
                        <?php } else { ?>
