...
requireAuthentication('../User/frontend/login.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'delete') {
    ...
    if ($idToDelete <= 0) {
        ...
        try {
            ...
            if ($targetReclamation === null || (int) $targetReclamation->getIdClient() !== (int) ($currentUser['id'] ?? 0)) {
...
$reclamations = $reclamationController->getByClientId((int) ($currentUser['id'] ?? 0));
