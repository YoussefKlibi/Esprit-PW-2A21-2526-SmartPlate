document.addEventListener('DOMContentLoaded', function () {
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', function (e) {
            ...
            if (!isValid) {
                e.preventDefault();
                // Focus the first input that has an error message to help the user
                const firstError = [prenomInfo, nomInfo, emailInfo, passInfo, confPassInfo].find(i => i.err && i.err.textContent.trim() !== '');
