...
if (isset($_GET['code'])) {
    ...
    if (isset($tokenData['access_token'])) {
        ...
        if (isset($userData['email'])) {
            ...
            // Autoriser la première connexion Google même si l'email n'existe pas encore :
            // createOrGetGoogleUser() créera automatiquement le compte si nécessaire.
            ...
            if ($user) {
                ...
                try {
                    ...
                    $denyLink = "http://localhost:8080/Integration_User_Reclamation/view/User/frontend/deny_login.php?token=" . $token;
