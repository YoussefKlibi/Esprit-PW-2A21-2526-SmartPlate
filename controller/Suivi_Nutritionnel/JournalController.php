...
require_once __DIR__ . '/../../view/config/auth.php';

class JournalController {
    private function resolveConnectedUserId(): int {
    ...
    public function add() {
        if (isset($_POST['date_journal']) && isset($_POST['poids_actuel'])) {
            ...
            $id_user = isset($_POST['id_utilisateur']) ? (int)$_POST['id_utilisateur'] : $this->resolveConnectedUserId();
            if ($id_user <= 0) {
                header('Location: ../../view/User/frontend/login.php');
                exit();
            }
            ...
            if ($referer) {
                ...
                header('Location: ../../view/Suivi_Nutritionnel/FrontOffice/Journal.php');
            }
            exit(); 
        }
    }
    ...
    public function edit($id) {
        ...
        header('Location: ../../view/Suivi_Nutritionnel/FrontOffice/Journal.php?edit_id=' . urlencode($id));
        exit();
    }
